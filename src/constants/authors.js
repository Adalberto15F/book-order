const autores = [
  ...
  **John Ronald Reuel Tolkien**, mais conhecido como **J.R.R. Tolkien**, foi um renomado escritor, professor e filólogo britânico, nascido em 3 de janeiro de 1892, em Bloemfontein, África do Sul, e falecido em 2 de setembro de 1973, em Bournemouth, Inglaterra. Ele é amplamente reconhecido como o criador das obras de fantasia **"O Senhor dos Anéis"** (*The Lord of the Rings*) e **"O Hobbit"** (*The Hobbit*), que são consideradas algumas das maiores e mais influentes histórias de fantasia da literatura mundial.
  ...
  Martin começou sua carreira de escritor muito jovem, vendendo histórias de ficção científica para revistas ainda adolescente. Ele se formou em jornalismo na **Northwestern University** em 1970 e, durante os anos 70 e 80, escreveu para várias publicações e séries de televisão, incluindo *The Twilight Zone* e *Beauty and the Beast*.
  
  ## As Crônicas de Gelo e Fogo
  Em 1996, Martin lançou *A Game of Thrones*, o primeiro livro de *As Crônicas de Gelo e Fogo*, uma série planejada para sete volumes. Os livros se tornaram um fenômeno global, conhecidos por seu realismo brutal, intrigas políticas e personagens complexos. Até hoje, cinco livros da série foram publicados:
...
1. **A Game of Thrones** (1996)
  ...
  Os fãs aguardam ansiosamente os dois volumes finais, *The Winds of Winter* e *A Dream of Spring*.
  
  ## Game of Thrones
  A popularidade da série de livros atraiu a atenção da HBO, que adaptou *As Crônicas de Gelo e Fogo* para a série de televisão *Game of Thrones*, exibida de 2011 a 2019. A série se tornou um sucesso mundial, embora tenha sido alvo de críticas pelo final, que divergiu dos livros ainda inacabados de Martin.
  
  ## Outros Trabalhos
  Além de *As Crônicas de Gelo e Fogo*, Martin também escreveu uma série de contos, romances de ficção científica e horror, como *Nightflyers* e *Fevre Dream*. Ele é editor da série *Wild Cards*, uma antologia de super-heróis, e continua ativo na criação de conteúdos dentro e fora do universo de Westeros.
  
  ## Vida Pessoal e Legado
  Martin vive em Santa Fé, Novo México, com sua esposa, Parris McBride. Ele é conhecido por seu apego aos personagens e pela criação de tramas complexas e realistas. Além de escritor, ele administra uma fundação de caridade e participa de convenções de fãs.
  
  George R.R. Martin é amplamente reconhecido como um dos mais influentes autores de fantasia contemporânea, e sua obra continua a impactar a cultura popular mundial.
